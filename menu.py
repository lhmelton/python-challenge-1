#Assignment completed by referencing Chat GPT, W3Schools.com and python.org
# Menu dictionary
menu = {
    "Snacks": {
        "Cookie": .99,
...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            food_item = input("Type menu number: ")
            ...
            if food_item.isdigit():
                ...
                if food_item in menu_items:
                    ...
                    selected_item = menu_items[food_item]["Item name"]
    ...
    while True:
        ...
        if keep_ordering.lower() == 'y':
            ...
            print("Please enter 'yes' or 'no' to continue or exit ordering.")
